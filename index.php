...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Elder Care</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/dhaka.html">Nagpur</a></li>
      <li>  <a href='location map/chittagong.html'>Pune</a></li>
       <li> <a href="location map/barishal.html">Mumbai</a></li>
      <li>  <a href="location map/khulna.html">Nashik</a></li>
     <li>   <a href='location map/mymensingh.html'>Jalgao</a></li>
     <li>   <a href='location map/rajshahi.html'>Aurangabad</a></li>
     <li>   <a href='location map/rangpur.html'>Latur</a></li>
     <li>   <a href='location map/sylhet.html'>Akola</a></li>
        </ul>
        </li>
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">Elder Care</h3>
  <p class="text-center"><em>We are here to hear and heal your health problems.</em></p>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Nagpur, Maharashtra India<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +088......<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  rutuja@gmail.com<br>
      </div>
      <?php
